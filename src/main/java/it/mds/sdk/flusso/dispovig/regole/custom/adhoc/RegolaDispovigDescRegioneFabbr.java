...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("RegolaDispovigDescRegioneFabbr")
public class RegolaDispovigDescRegioneFabbr extends RegolaGenerica {
	
	public RegolaDispovigDescRegioneFabbr(String nome, String codErrore, String desErrore, Parametri parametri) {
	...
	public List<Esito> valida(String nomeCampo, RecordDtoGenerico recordDtoGenerico) {
		...
		try {						
			...
			if ("IT".equalsIgnoreCase(rapporto_dispositivo_nazioneFabbricante)) {
				if (StringUtils.isBlank(rapporto_dispositivo_descRegioneFabbricante)) {	
			...
			listaEsiti.add(creaEsitoOk(nomeCampo));
				...
				log.error("Non è possibile validare la regola RegolaDispovigDescRegioneFabbr " + nomeCampo, e);
			throw new ValidazioneImpossibileException("Non è possibile validare la regola RegolaDispovigDescRegioneFabbr " + nomeCampo );
