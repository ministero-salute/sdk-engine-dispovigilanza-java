...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaIncongruenzaCrossDueCampi")
public class RegolaIncongruenzaCrossDueCampi extends RegolaGenerica{


	public RegolaIncongruenzaCrossDueCampi(String nomeRegola, String codErrore, String desErrore, Parametri parametri) {
