...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("RegolaDispovigIndirizzoMandatario")
public class RegolaDispovigIndirizzoMandatario extends RegolaGenerica {
	
	public RegolaDispovigIndirizzoMandatario(String nome, String codErrore, String desErrore, Parametri parametri) {
...
//							: null);
			...
			String rapporto_dispositivo_indirizzoMandatario = (recordDtoGenerico
					.getCampo("rapporto_dispositivo_indirizzoMandatario") != null
							? (String) recordDtoGenerico.getCampo("rapporto_dispositivo_indirizzoMandatario")
							: null);
			...
			if (listaNaizoneNonUE.contains(rapporto_dispositivo_descNazioneFabbricante+"#"+rapporto_dispositivo_nazioneFabbricante)) {
				if (StringUtils.isBlank(rapporto_dispositivo_indirizzoMandatario)) {	
			...
			if (listaDispositiviMedici.contains(rapporto_dispositivo_codiceDispositivo)) {
				/*
				 * TODO: codice dispositivo esiste - verificare che l'indirizzo del fabbricante
				 * sia uguale a quello presente sul db -
				 * rapporto_dispositivo_indirizzoMandatario - codErr: 1129
				 */
			...
			listaEsiti.add(creaEsitoOk(nomeCampo));
				...
				log.error("Non è possibile validare la regola RegolaDispovigIndirizzoMandatario " + nomeCampo, e);
			throw new ValidazioneImpossibileException("Non è possibile validare la regola RegolaDispovigIndirizzoMandatario " + nomeCampo );
