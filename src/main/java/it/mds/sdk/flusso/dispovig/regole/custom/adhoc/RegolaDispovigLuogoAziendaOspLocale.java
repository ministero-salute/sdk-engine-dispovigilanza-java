...
public class RegolaDispovigLuogoAziendaOspLocale extends RegolaGenerica {
	
	public RegolaDispovigLuogoAziendaOspLocale(String nome, String codErrore, String desErrore, Parametri parametri) {
