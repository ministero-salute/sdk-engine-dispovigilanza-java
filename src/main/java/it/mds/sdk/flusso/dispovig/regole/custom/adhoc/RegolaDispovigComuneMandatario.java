...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("RegolaDispovigComuneMandatario")
public class RegolaDispovigComuneMandatario extends RegolaGenerica {
	
	public RegolaDispovigComuneMandatario(String nome, String codErrore, String desErrore, Parametri parametri) {
	...
	public List<Esito> valida(String nomeCampo, RecordDtoGenerico recordDtoGenerico) {
		...
		try {						
			...
			if ("IT".equalsIgnoreCase(rapporto_dispositivo_nazioneMandatario) &&
				...
				if (StringUtils.isBlank(rapporto_dispositivo_comuneMandatario)) {	
				...
				if (!listaDispositiviMedici.contains(rapporto_dispositivo_codiceDispositivo)) {
					...
					/*
					 * TODO: codice dispositivo esiste - verificare che il comune del fabbricante
			...
			listaEsiti.add(creaEsitoOk(nomeCampo));
				...
				log.error("Non è possibile validare la regola RegolaDispovigComuneMandatario " + nomeCampo, e);
			throw new ValidazioneImpossibileException("Non è possibile validare la regola RegolaDispovigComuneMandatario " + nomeCampo );
