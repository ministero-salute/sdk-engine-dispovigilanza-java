...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("RegolaDispovigLuogoIncidente")
public class RegolaDispovigLuogoIncidente extends RegolaGenerica {
	
	public RegolaDispovigLuogoIncidente(String nome, String codErrore, String desErrore, Parametri parametri) {
		...
		try {
			String rapporto_luogoEpisodio_nomeStruttura = (recordDtoGenerico
					.getCampo("rapporto_luogoEpisodio_nomeStruttura") != null
							...
							: null);
			String rapporto_luogoEpisodio_codiceStruttura = (recordDtoGenerico
...
//							: null);
			...
			List<String> luoghiIncidente = Utilities.getValoriAnagrafica("ANAG_DISPOVIG_LUOGHI_INCI",rapporto_luogoEpisodio_nomeStruttura + "#" + rapporto_luogoEpisodio_codiceStruttura);

			if (luoghiIncidente
					.contains(rapporto_luogoEpisodio_nomeStruttura + "#" + rapporto_luogoEpisodio_codiceStruttura)) {
				...
				log.error("Non è possibile validare la regola RegolaDispovigLuogoIncidente " + nomeCampo, e);
			throw new ValidazioneImpossibileException("Non è possibile validare la regola RegolaDispovigLuogoIncidente " + nomeCampo );
