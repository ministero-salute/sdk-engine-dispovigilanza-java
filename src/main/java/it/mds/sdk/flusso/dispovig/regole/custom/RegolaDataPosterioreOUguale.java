...
public class RegolaDataPosterioreOUguale extends RegolaGenerica {
	
	public static final DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");

	public RegolaDataPosterioreOUguale(String nome, String codErrore, String desErrore, Parametri parametri) {
