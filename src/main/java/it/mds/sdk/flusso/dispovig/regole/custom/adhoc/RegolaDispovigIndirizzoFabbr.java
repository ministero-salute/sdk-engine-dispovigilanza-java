...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("RegolaDispovigIndirizzoFabbr")
public class RegolaDispovigIndirizzoFabbr extends RegolaGenerica {
	
	public RegolaDispovigIndirizzoFabbr(String nome, String codErrore, String desErrore, Parametri parametri) {
...
//							: null);
			...
			String rapporto_dispositivo_indirizzoFabbricante = (recordDtoGenerico
					.getCampo("rapporto_dispositivo_indirizzoFabbricante") != null
							? (String) recordDtoGenerico.getCampo("rapporto_dispositivo_indirizzoFabbricante")
							: null);
			...
			listaEsiti.add(creaEsitoOk(nomeCampo));
				...
				log.error("Non è possibile validare la regola RegolaDispovigIndirizzoFabbr " + nomeCampo, e);
			throw new ValidazioneImpossibileException("Non è possibile validare la regola RegolaDispovigIndirizzoFabbr " + nomeCampo );
