...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("RegolaDueLunghezzeAlternative")
public class RegolaDueLunghezzeAlternative extends RegolaGenerica {

    public RegolaDueLunghezzeAlternative(String nomeRegola, String codErrore, String desErrore, Parametri parametri) {
