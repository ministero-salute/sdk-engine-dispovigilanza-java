...
class RegolaDispovigDescComuneMandatarioTest {
    @Mock
    ...
    RegolaDispovigDescComuneMandatario regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDispovigDescComuneMandatario("TEST", "TEST", "TEST", parametriTest));
    }
    @AfterEach
    void close(){
        utilities.close();
    ...
    void costruttoreVuoto() {
        RegolaDispovigDescComuneMandatario regola = new RegolaDispovigDescComuneMandatario();
        assertTrue(regola instanceof RegolaDispovigDescComuneMandatario);
    }
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        List<String> lista3 = new ArrayList<>();lista.add("123456");
    ...
    void validaKO() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_comuneMandatario")).thenReturn("1");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descComuneMandatario")).thenReturn("");
    ...
    void validaKO2() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_provinciaMandatario")).thenReturn("RM");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_comuneMandatario")).thenReturn("1");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descComuneMandatario")).thenReturn("COMUNE");
