...
class RegolaDispovigNazioneMandatarioTest {
    @Mock
    ...
    RegolaDispovigNazioneMandatario regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDispovigNazioneMandatario("TEST", "TEST", "TEST", parametriTest));
    }
    @AfterEach
    void close(){
        utilities.close();
    ...
    void costruttoreVuoto() {
        RegolaDispovigNazioneMandatario regola = new RegolaDispovigNazioneMandatario();
        assertTrue(regola instanceof RegolaDispovigNazioneMandatario);
    }
    ...
    void validaKO2() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_nazioneFabbricante")).thenReturn("GG");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descNazioneFabbricante")).thenReturn("GGGGG");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_nazioneMandatario")).thenReturn("GG");
    ...
    void validaKO() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descNazioneFabbricante")).thenReturn("ITALIA");
