...
class RegolaDispovigLocalitaMandatarioTest {
    @Mock
    ...
    RegolaDispovigLocalitaMandatario regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDispovigLocalitaMandatario("TEST", "TEST", "TEST", parametriTest));
    }
    @AfterEach
    void close(){
        utilities.close();
    ...
    void costruttoreVuoto() {
        RegolaDispovigLocalitaMandatario regola = new RegolaDispovigLocalitaMandatario();
        assertTrue(regola instanceof RegolaDispovigLocalitaMandatario);
    }
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_localitaMandatario")).thenReturn("1");
