...
class RegolaDispovigLocalitaFabbrTest {
    @Mock
    ...
    RegolaDispovigLocalitaFabbr regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDispovigLocalitaFabbr("TEST", "TEST", "TEST", parametriTest));
    }
    @AfterEach
    void close(){
        utilities.close();
    ...
    void costruttoreVuoto() {
        RegolaDispovigLocalitaFabbr regola = new RegolaDispovigLocalitaFabbr();
        assertTrue(regola instanceof RegolaDispovigLocalitaFabbr);
    }
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_localitaFabbricante")).thenReturn("1");
