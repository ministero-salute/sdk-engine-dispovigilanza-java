...
class RegolaDueLunghezzeAlternativeTest {

    @Mock
    RecordDtoGenerico recordMockito;
    RegolaDueLunghezzeAlternative regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDueLunghezzeAlternative("TEST", "TEST", "TEST", parametriTest));
    }

    @Test
    void validaCostruttore() {
        RegolaDueLunghezzeAlternative regola = new RegolaDueLunghezzeAlternative();
        assertTrue(regola instanceof RegolaDueLunghezzeAlternative);
    }
    ...
    void validaKO() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException {
        ...
        RegolaDueLunghezzeAlternative regola = new RegolaDueLunghezzeAlternative("RegolaDueLunghezzeAlternative", "9999", "descrizioneErrore",parametriTest);
