...
class RegolaDispovigProvinciaMandatarioTest {
    @Mock
    ...
    RegolaDispovigProvinciaMandatario regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDispovigProvinciaMandatario("TEST", "TEST", "TEST", parametriTest));
    }
    @AfterEach
    void close(){
        utilities.close();
    ...
    void costruttoreVuoto() {
        RegolaDispovigProvinciaMandatario regola = new RegolaDispovigProvinciaMandatario();
        assertTrue(regola instanceof RegolaDispovigProvinciaMandatario);
    }
    ...
    void validaKO3() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descProvinciaMandatario")).thenReturn("ROMA");
    ...
    void validaKO2() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descNazioneFabbricante")).thenReturn("PAKISTAN");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_nazioneMandatario")).thenReturn("IT");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_provinciaMandatario")).thenReturn("");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descProvinciaMandatario")).thenReturn("ROMA");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_regioneMandatario")).thenReturn("120");
