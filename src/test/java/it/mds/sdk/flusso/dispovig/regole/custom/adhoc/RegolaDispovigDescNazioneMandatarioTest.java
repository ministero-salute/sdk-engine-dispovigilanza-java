...
class RegolaDispovigDescNazioneMandatarioTest {
    @Mock
    ...
    RegolaDispovigDescNazioneMandatario regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDispovigDescNazioneMandatario("TEST", "TEST", "TEST", parametriTest));
    }
    @AfterEach
    void close(){
        utilities.close();
    ...
    void costruttoreVuoto() {
        RegolaDispovigDescNazioneMandatario regola = new RegolaDispovigDescNazioneMandatario();
        assertTrue(regola instanceof RegolaDispovigDescNazioneMandatario);
    }
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descNazioneMandatario")).thenReturn("1");
        ...
        utilities.when(() -> Utilities.getValoriAnagrafica(eq("ANAG_DISPOVIG_NAZIONE_DESC"),anyString())).thenReturn(lista2);
    ...
    void validaOK2() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descNazioneMandatario")).thenReturn("ITALIA");
