...
class RegolaDispovigDescProvinciaMandatarioTest {
    @Mock
    ...
    RegolaDispovigDescProvinciaMandatario regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDispovigDescProvinciaMandatario("TEST", "TEST", "TEST", parametriTest));
    }
    @AfterEach
    void close(){
        utilities.close();
    ...
    void costruttoreVuoto() {
        RegolaDispovigDescProvinciaMandatario regola = new RegolaDispovigDescProvinciaMandatario();
        assertTrue(regola instanceof RegolaDispovigDescProvinciaMandatario);
    }
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descProvinciaMandatario")).thenReturn("1");
        ...
        utilities.when(() -> Utilities.getValoriAnagrafica(eq("ANAG_DISPOVIG_PROVINCIA"),anyString())).thenReturn(lista3);
