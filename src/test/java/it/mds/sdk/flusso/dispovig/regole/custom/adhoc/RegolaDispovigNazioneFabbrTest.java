...
class RegolaDispovigNazioneFabbrTest {
    @Mock
    ...
    RegolaDispovigNazioneFabbr regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDispovigNazioneFabbr("TEST", "TEST", "TEST", parametriTest));
    }
    @AfterEach
    void close(){
        utilities.close();
    ...
    void costruttoreVuoto() {
        RegolaDispovigNazioneFabbr regola = new RegolaDispovigNazioneFabbr();
        assertTrue(regola instanceof RegolaDispovigNazioneFabbr);
    }
    ...
    void validaKO2() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        utilities.when(() -> Utilities.getValoriAnagrafica(eq("ANAG_DISPOVIG_NAZIONE"),anyString())).thenReturn(lista);
