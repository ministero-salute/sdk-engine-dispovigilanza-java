...
class RegolaDispovigIndirizzoFabbrTest {
    @Mock
    ...
    RegolaDispovigIndirizzoFabbr regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDispovigIndirizzoFabbr("TEST", "TEST", "TEST", parametriTest));
    }
    @AfterEach
    void close(){
        utilities.close();
    ...
    void costruttoreVuoto() {
        RegolaDispovigIndirizzoFabbr regola = new RegolaDispovigIndirizzoFabbr();
        assertTrue(regola instanceof RegolaDispovigIndirizzoFabbr);
    }
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_indirizzoFabbricante")).thenReturn("1");
