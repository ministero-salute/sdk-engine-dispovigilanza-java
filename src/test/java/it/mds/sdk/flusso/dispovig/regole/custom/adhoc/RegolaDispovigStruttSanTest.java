...
class RegolaDispovigStruttSanTest {
    @Mock
    ...
    RegolaDispovigStruttSan regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDispovigStruttSan("TEST", "TEST", "TEST", parametriTest));
    }

    @Test
    void costruttoreVuoto() {
        RegolaDispovigStruttSan regola = new RegolaDispovigStruttSan();
        assertTrue(regola instanceof RegolaDispovigStruttSan);
    }
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_compilatore_struttSanitaria")).thenReturn("1");
