...
class RegolaDispovigDescComuneFabbrTest {
    @Mock
    ...
    RegolaDispovigDescComuneFabbr regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDispovigDescComuneFabbr("TEST", "TEST", "TEST", parametriTest));
    }
    @AfterEach
    void close(){
        utilities.close();
    ...
    void costruttoreVuoto() {
        RegolaDispovigDescComuneFabbr regola = new RegolaDispovigDescComuneFabbr();
        assertTrue(regola instanceof RegolaDispovigDescComuneFabbr);
    }
    ...
    void validaOK2() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descComuneFabbricante")).thenReturn("denominazione");
    ...
    void validaKO() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_provinciaFabbricante")).thenReturn("1");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_comuneFabbricante")).thenReturn("");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descComuneFabbricante")).thenReturn("");
