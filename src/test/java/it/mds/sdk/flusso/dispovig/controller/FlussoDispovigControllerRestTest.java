...
public class FlussoDispovigControllerRestTest {
    @InjectMocks
    @Spy
    private FlussoDispovigControllerRest controller;
    ...
    @Mock
    private FlussoDispovigService service;
    private ConfigurazioneFlussoDispovig.Rules rules = mock(ConfigurazioneFlussoDispovig.Rules.class);

    private ConfigurazioneFlussoDispovig.Flusso flusso = mock(ConfigurazioneFlussoDispovig.Flusso.class);
    ...
    private ConfigurazioneFlussoDispovig.NomeFlusso nomeFlusso = mock(ConfigurazioneFlussoDispovig.NomeFlusso.class);
