...
class RegolaDispovigProvinciaFabbrTest {
    @Mock
    ...
    RegolaDispovigProvinciaFabbr regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDispovigProvinciaFabbr("TEST", "TEST", "TEST", parametriTest));
    }
    @AfterEach
    void close(){
        utilities.close();
    ...
    void costruttoreVuoto() {
        RegolaDispovigProvinciaFabbr regola = new RegolaDispovigProvinciaFabbr();
        assertTrue(regola instanceof RegolaDispovigProvinciaFabbr);
    }
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_regioneFabbricante")).thenReturn("120");
