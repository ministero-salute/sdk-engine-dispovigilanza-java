...
class RegolaDispovigDenomFabbrTest {
    @Mock
    ...
    RegolaDispovigDenomFabbr regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDispovigDenomFabbr("TEST", "TEST", "TEST", parametriTest));
    }
    @AfterEach
    void close(){
        utilities.close();
    ...
    void costruttoreVuoto() {
        RegolaDispovigDenomFabbr regola = new RegolaDispovigDenomFabbr();
        assertTrue(regola instanceof RegolaDispovigDenomFabbr);
    }
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        utilities.when(() -> Utilities.getValoriAnagrafica(eq("ANAG_DISPOVIG_FABBRICANTE"),anyString())).thenReturn(lista2);
