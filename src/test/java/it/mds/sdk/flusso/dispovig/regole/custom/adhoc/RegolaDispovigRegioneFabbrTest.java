...
class RegolaDispovigRegioneFabbrTest {
    @Mock
    ...
    RegolaDispovigRegioneFabbr regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDispovigRegioneFabbr("TEST", "TEST", "TEST", parametriTest));
    }
    @AfterEach
    void close(){
        utilities.close();
    ...
    void costruttoreVuoto() {
        RegolaDispovigRegioneFabbr regola = new RegolaDispovigRegioneFabbr();
        assertTrue(regola instanceof RegolaDispovigRegioneFabbr);
    }
    ...
    void validaKO2() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_regioneFabbricante")).thenReturn("");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descRegioneFabbricante")).thenReturn("1");
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descRegioneFabbricante")).thenReturn("REGIONE");
