...
class RegolaDispovigLuogoEpiCodStruttTest {
    @Mock
    ...
    RegolaDispovigLuogoEpiCodStrutt regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDispovigLuogoEpiCodStrutt("TEST", "TEST", "TEST", parametriTest));
    }
    @AfterEach
    void close(){
        utilities.close();
    ...
    void costruttoreVuoto() {
        RegolaDispovigLuogoEpiCodStrutt regola = new RegolaDispovigLuogoEpiCodStrutt();
        assertTrue(regola instanceof RegolaDispovigLuogoEpiCodStrutt);
    }
