...
class RegolaDispovigComuneFabbrTest {
    @Mock
    ...
    RegolaDispovigComuneFabbr regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDispovigComuneFabbr("TEST", "TEST", "TEST", parametriTest));
    }
    @AfterEach
    void close(){
        utilities.close();
    ...
    void costruttoreVuoto() {
        RegolaDispovigComuneFabbr regola = new RegolaDispovigComuneFabbr();
        assertTrue(regola instanceof RegolaDispovigComuneFabbr);
    }
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_comuneFabbricante")).thenReturn("1");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descComuneFabbricante")).thenReturn("1");
        ...
        utilities.when(() -> Utilities.getValoriAnagrafica(eq("ANAG_DISPOVIG_COMUNE"),anyString())).thenReturn(lista2);
    ...
    void validaOK2() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_comuneFabbricante")).thenReturn("066101");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descComuneFabbricante")).thenReturn("ROMA");
    ...
    void validaKO() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_nazioneFabbricante")).thenReturn("IT");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_provinciaFabbricante")).thenReturn("RM");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_comuneFabbricante")).thenReturn("");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descComuneFabbricante")).thenReturn("ROMA");
