...
class RegolaDispovigComuneMandatarioTest {
    @Mock
    ...
    RegolaDispovigComuneMandatario regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDispovigComuneMandatario("TEST", "TEST", "TEST", parametriTest));
    }
    @AfterEach
    void close(){
        utilities.close();
    ...
    void costruttoreVuoto() {
        RegolaDispovigComuneMandatario regola = new RegolaDispovigComuneMandatario();
        assertTrue(regola instanceof RegolaDispovigComuneMandatario);
    }
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_provinciaMandatario")).thenReturn("1");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_comuneMandatario")).thenReturn("1");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descComuneMandatario")).thenReturn("1");

        List<String> lista = new ArrayList<>();lista.add("123456");
        List<String> lista2 = new ArrayList<>();lista.add("123456");
        List<String> lista3 = new ArrayList<>();lista.add("001");
        ...
        utilities.when(() -> Utilities.getValoriAnagrafica(eq("ANAG_DISPOVIG_COMUNE"),anyString())).thenReturn(lista3);
    ...
    void validaOK2() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_provinciaMandatario")).thenReturn("RM");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_comuneMandatario")).thenReturn("111111");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descComuneMandatario")).thenReturn("ROMA");
    ...
    void validaKO() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_nazioneMandatario")).thenReturn("IT");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_provinciaMandatario")).thenReturn("RM");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_comuneMandatario")).thenReturn("");
        Mockito.when(recordMockito.getCampo("rapporto_dispositivo_descComuneMandatario")).thenReturn("ROMA");
